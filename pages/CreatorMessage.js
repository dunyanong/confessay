        ...
        <nav className="py-10 mb-12 flex justify-between items-center ">
            ...
            <div className="mb-11 mt-5">
                <ul className="font-medium text-gray-700">
                    <div className="my-3 ">
                        <h3 className="text-2xl font-medium">1. It must be a confession.</h3>
                        <p>The confession can be the current state of mind, feelings and hardships of coping</p>
                    </div>
                    <div className="my-3">
                        <h3 className="text-2xl font-medium">2. No names or contact information to be shared. </h3>
                        <p>If you are comfortable sharing your own name too, go ahead.</p>
                    </div>
                    <div className="my-3">
                        <h3 className="text-2xl font-medium">3. Foul languages and hurtful comments are prohibited. </h3>
                        <p>Be empathetic for the people who need to lend a pair of ear.</p>
                    </div>
                    <div className="my-3">
                        <h3 className="text-2xl font-medium">4. Avoid controversial topics. </h3>
                        <p>That means political posts, racial discrimination (unless you are the victim), religious views are not allowed.</p>
                    </div>
            ...
            <h2 id="accordion-open-heading-2">
                <button type="button" onClick={changeStyle1} className="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-gray-200 hover:bg-gray-100" data-accordion-target="#accordion-open-body-2" aria-expanded="false" aria-controls="accordion-open-body-2">
            ...
            <div id="accordion-open-body-2" className={style1} aria-labelledby="accordion-open-heading-2">
                ...
                <p className="mb-2 text-gray-500">The aim of Confessay is to allow people to talk about or express emotion freely and to avoid bottling up emotions.</p>
                <p className="text-gray-500">Describing and talking about an emotion out loud tends to decrease its effect of it.</p>
                </div>
            </div>
            ...
            <div id="accordion-open-body-2" className={style2} aria-labelledby="accordion-open-heading-2">
                ...
                <p className="text-gray-500">Click here to know more: <a href="https://github.com/dunyanong" className="text-cyan-700 font-medium"  target="_blank"> more info</a></p>
                </div>
            </div>
            ...
            <h2 id="accordion-open-heading-2">
                <button type="button" onClick={changeStyle4} className="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-gray-200 hover:bg-gray-100" data-accordion-target="#accordion-open-body-2" aria-expanded="false" aria-controls="accordion-open-body-2">
