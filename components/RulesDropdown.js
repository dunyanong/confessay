...
const RulesDropdown = () => {
    ...
    return (
        ...
        <h2 id="accordion-open-heading-2">
            <button type="button" onClick={changeStyle1} className="rounded-t-lg flex items-center justify-between w-full p-5 font-medium text-left text-gray-700 border border-gray-200 hover:bg-gray-100" data-accordion-target="#accordion-open-body-2" aria-expanded="false" aria-controls="accordion-open-body-2">
        ...
        <div id="accordion-open-body-2" className={style1} aria-labelledby="accordion-open-heading-2">
            ...
            <p className="mb-2 font-medium">The aim of Confessay is to allow people to talk about or express emotion freely and to avoid bottling up emotions.</p>
            <p className="mb-2 font-medium">Describing and talking about an emotion out loud tends to decrease its effect of it.</p>
            <p className="mb-2 font-medium">Source: <a className="text-cyan-700 font-medium"  target="_blank" href="https://pubmed.ncbi.nlm.nih.gov/3612492/">research1</a>, <a className="text-cyan-700 font-medium"  target="_blank" href="https://www.researchgate.net/publication/323518229_Culture_emotion_suppression_and_disclosure_and_health">research2inPDF</a></p>
            </div>
        </div>

        <h2 id="accordion-open-heading-2">
            <button type="button" onClick={changeStyle2} className="flex items-center justify-between w-full p-5 font-medium text-left text-gray-700 border border-gray-200 hover:bg-gray-100" data-accordion-target="#accordion-open-body-2" aria-expanded="false" aria-controls="accordion-open-body-2">
        ...
        <h2 id="accordion-open-heading-2">
            <button type="button" onClick={changeStyle3} className="flex items-center justify-between w-full p-5 font-medium text-left text-gray-700 border border-gray-200 hover:bg-gray-100" data-accordion-target="#accordion-open-body-2" aria-expanded="false" aria-controls="accordion-open-body-2">
        ...
        <h2 id="accordion-open-heading-2">
            <button type="button" onClick={changeStyle4} className="rounded-b-lg flex items-center justify-between w-full p-5 font-medium text-left text-gray-700 border border-gray-200 hover:bg-gray-100" data-accordion-target="#accordion-open-body-2" aria-expanded="false" aria-controls="accordion-open-body-2">
