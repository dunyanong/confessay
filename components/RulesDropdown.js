...
const RulesDropdown = () => {
        ...
        let [style5, setStyle5] = useState("hiddenFunction5");
        let [style6, setStyle6] = useState("hiddenFunction6");
        ...
        const changeStyle5 = () => {
            setStyle5("visibleFunction5");
            
            if( style5 == "visibleFunction5"){
                setStyle5("hiddenFunction5");
            }
        }
        const changeStyle6 = () => {
            setStyle6("visibleFunction6");
            
            if( style6 == "visibleFunction6"){
                setStyle6("hiddenFunction6");
            }
        }
    return (
        ...
        <h2 id="accordion-open-heading-2">
            <button type="button" onClick={changeStyle2} className="rounded-t-lg flex items-center justify-between w-full p-5 text-left text-gray-700 border border-gray-200 hover:bg-gray-100" data-accordion-target="#accordion-open-body-2" aria-expanded="false" aria-controls="accordion-open-body-2">
        ...
        <div id="accordion-open-body-2" className={style3} aria-labelledby="accordion-open-heading-2">
            ...
            <p className="mb-2 text-gray-500">Confessay is founded and coded by a Malaysian Engineer, Dun Yan.</p>
        ...
        <h2 id="accordion-open-heading-2">
            <button type="button" onClick={changeStyle4} className="flex items-center justify-between w-full p-5 text-left text-gray-700 border border-gray-200 hover:bg-gray-100" data-accordion-target="#accordion-open-body-2" aria-expanded="false" aria-controls="accordion-open-body-2">
        ...
        <h2 id="accordion-open-heading-2">
            <button type="button" onClick={changeStyle5} className="rounded-b-lg flex items-center justify-between w-full p-5 text-left text-gray-700 border border-gray-200 hover:bg-gray-100" data-accordion-target="#accordion-open-body-2" aria-expanded="false" aria-controls="accordion-open-body-2">
        ...
        <h2 id="accordion-open-heading-2">
            <button type="button" onClick={changeStyle6} className="rounded-b-lg flex items-center justify-between w-full p-5 text-left text-gray-700 border border-gray-200 hover:bg-gray-100" data-accordion-target="#accordion-open-body-2" aria-expanded="false" aria-controls="accordion-open-body-2">
            <span className="flex items-center"><svg className="w-5 h-5 mr-2 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd"></path></svg>Technical Details</span>
            <svg data-accordion-icon className="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
            </button>
        </h2>
        <div id="accordion-open-body-2" className={style6} aria-labelledby="accordion-open-heading-2">
            <div className="p-5 font-light border border-gray-200 rounded-lg">                        
            <p className="mb-2 text-gray-500">Github: <a className="text-blue-600" href="https://github.com/dunyanong/confessay">link</a></p>
            </div>
        </div>        
